...
mod utils;
use utils::{
    errors::ProvisioningErrorCodes, identity_manager::{GetMachineIdResponse, GetProvisionStatusResponse, IdentityClient}, provision_manager::{
...
fn check_error(input: String) -> Result<String, ()> {
    ...
    if error_string.to_lowercase().contains(&ProvisioningErrorCodes::UnknownError.to_string().to_lowercase()) {
        Ok("Unknown Error".to_string())
    } else  if error_string.to_lowercase().contains(&ProvisioningErrorCodes::UnauthorizedError.to_string().to_lowercase()) {
        Ok("Unauthorized Error".to_string())
    } else if error_string.to_lowercase().contains(&ProvisioningErrorCodes::NotFoundError.to_string().to_lowercase()) {
        Ok("NotFound Error".to_string())
    } else if error_string.to_lowercase().contains(&ProvisioningErrorCodes::BadRequestError.to_string().to_lowercase()) {
        Ok("Bad Request Error".to_string())
    } else if error_string.to_lowercase().contains(&ProvisioningErrorCodes::UnreachableError.to_string().to_lowercase()) {
        Ok("Unreachable Error".to_string())
    } else if error_string.to_lowercase().contains(&ProvisioningErrorCodes::InternalServerError.to_string().to_lowercase()) {
        Ok("Internal Server Error".to_string())
    } else if error_string.to_lowercase().contains(&ProvisioningErrorCodes::CSRSignReadFileError.to_string().to_lowercase()) {
        Ok("CSRSign ReadFile Error".to_string())
    } else if error_string.to_lowercase().contains(&ProvisioningErrorCodes::CertificateWriteError.to_string().to_lowercase()) {
        Ok("CertificateWrite Error".to_string())
    } else if error_string.to_lowercase().contains(&ProvisioningErrorCodes::SendEventError.to_string().to_lowercase()) {
        Ok("SendEvent Error".to_string())
    } else if error_string.to_lowercase().contains(&ProvisioningErrorCodes::SettingsDatabaseDeleteError.to_string().to_lowercase()) {
        Ok("Settings Database Delete Error".to_string())
    } else if error_string.to_lowercase().contains(&ProvisioningErrorCodes::ParseResponseError.to_string().to_lowercase().to_lowercase()) {
        Ok("Parse Response Error".to_string())
    } else if error_string.to_lowercase().contains(&ProvisioningErrorCodes::ChannelSendMessageError.to_string().to_lowercase()) {
        Ok("Channel Send Message Error".to_string())
    } else if error_string.to_lowercase().contains(&ProvisioningErrorCodes::ChannelReceiveMessageError.to_string().to_lowercase()) {
        Ok("Channel Receive Message Error".to_string())
    } else if error_string.to_lowercase().contains(&ProvisioningErrorCodes::MachineMismatchError.to_string().to_lowercase()) {
        Ok("Machine Mismatch Error".to_string())
    } else if error_string.to_lowercase().contains(&ProvisioningErrorCodes::ExtractMessagePayloadError.to_string().to_lowercase()) {
        Ok("Extract Message Payload Error".to_string())
    } else if error_string.to_lowercase().contains(&ProvisioningErrorCodes::DeprovisioningError.to_string().to_lowercase()) {
        Ok("Deprovisioning Error".to_string())
    } else if error_string.to_lowercase().contains(&ProvisioningErrorCodes::SubscribeToNatsError.to_string().to_lowercase()) {
        Ok("Subscribe ToNats Error".to_string())
    } else if error_string.to_lowercase().contains(&ProvisioningErrorCodes::PayloadDeserializationError.to_string().to_lowercase()) {
        Ok("Payload Deserialization Error".to_string())
    } else if error_string.to_lowercase().contains(&ProvisioningErrorCodes::InvalidMachineIdError.to_string().to_lowercase()) {
